...
public class AuthenticationService {
    ...
    public AuthenticationResponse register(@NotNull RegisterRequest request) {
        ...
        String link = String.format(EMAIL_LINK_TEMPLATE, SERVER_LINK, jwtToken);
...
//            throw new CustomException("TOKEN_EXPIRED", "");
    ...
    public AuthenticationResponse forget_password(@NotNull AuthenticationRequest request) {
        User user = userService.findByEmail(request.getEmail())
                .orElseThrow(() -> new CustomException("EMAIL_NOT_FOUND", "信箱未找到"));
